                ...
                (function($) {
                    var datatable = $(".table-editable").dataTable({
                        ...
                        fnRowCallback: function fnRowCallback(
                            ...
                            var setCell = function setCell(response, newValue) {
                                ...
                                var cellData = cell.data(); // return a to change
                                var div = document.createElement("div");
                                div.innerHTML = cellData;
                                var a = div.childNodes[0]; // return first child
                                a.innerHTML = newValue; // div => a => new value
                    ...
                    function highlightCell($cell) {
                        ...
                        if (originalValue === actualValue) {
                            $cell
                                .removeClass("cat-cell-modified")
                                .addClass("cat-cell-original");
                        } else {
                            $cell
                                .removeClass("cat-cell-original")
                                .addClass("cat-cell-modified");
                        }
                    }
                    ...
                    function addAutoFillHandler() {
                        ...
                        table.on("autoFill", function(e, datatable, cells) {
                            var datatableCellApis = $.each(cells, function(
                                index,
                                row
                            ) {
  ...
  \*********************************************************/
            ...
            /***/ function(module, exports, __webpack_require__) {
                module.exports = __webpack_require__(
                    /*! C:\wamp64\www\waslastore\resources\js\pages\table-editable.init.js */ "./resources/js/pages/table-editable.init.js"
                );
