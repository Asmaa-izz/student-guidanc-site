        ...
        <div class="right-bar">
            <div data-simplebar class="h-100">
                ...
                {{-- <div class="p-4">
                    ...
                    <div class="custom-control custom-switch mb-3">
                        <input type="checkbox" class="custom-control-input theme-choice" id="dark-mode-switch" data-bsStyle="{{ URL::asset('assets/css/bootstrap-dark.min.css') }}" data-appStyle="{{ URL::asset('assets/css/app-dark.min.css') }}" />
                    ...
                    <div class="custom-control custom-switch mb-5">
                        <input type="checkbox" class="custom-control-input theme-choice" id="rtl-mode-switch" data-appStyle="{{ URL::asset('assets/css/app-rtl.min.css') }}" />
