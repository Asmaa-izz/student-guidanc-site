                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control" name="guardian_attribute" id="guardian_attribute" placeholder="أدخل  صفة ولي الامر"
                                       value="{{ $student->guardian->attribute }}">
                                ...
                                <select class="select2 form-control" required
                                    ...
                                    @foreach ($teachers as $teacher)
                                        <option value="{{ $teacher->id }}"
                                                {{  $teacher_id ===  $teacher->id ? 'selected' : null }}
                                                data-idcat="{{ $teacher->id  }}">
                                            {{ $teacher->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                                ...
                                <select class="select2 form-control" required
                                    ...
                                    @foreach ($mentors as $mentor)
                                        <option value="{{ $mentor->id }}"
                                                {{  $mentor_id ===  $mentor->id ? 'selected' : null }}
                                                data-idcat="{{ $mentor->id  }}">
                                            {{ $mentor->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <textarea class="form-control" id="notes" name="notes" rows="2">{{ $student->notes }}</textarea>
                                @error('notes')
                                <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
